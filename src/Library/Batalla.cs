...
public class Batalla
{
    ...
    private void Atacar(Jugador jugadorActual, Jugador jugadorOponente)
    {
        ...
        // Realizar el ataque
        PokemonActual.Atacar(jugadorActual.Equipo[0], jugadorOponente.PokemonActual, PokemonActual.Moves[movimientoSeleccionado]); // Suponiendo que el oponente es el primer Pokémon
    }
